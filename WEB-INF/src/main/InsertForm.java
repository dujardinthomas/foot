		...
		if (p == null) {
			...
			if (p.getRole().equals("admin") || p.getRole().equals("capitaine")) {
				if (((table.equals("joueurs")) || (table.equals("equipes")) || (table.equals("rencontres")))
					...
					out.println("<h1>Ajout d'un(e) " + table.substring(0, table.length() - 1) + " : </h1> ");
					out.println("<br>");
					...
					try {
						...
						out.println("<form action=" + "servlet-insert>");
						...
						out.println("<input type=submit value=Inserer></form>");
					...
					System.out.println("PAS AUTORISE A INSERER SUR D'AUTRES TABLES");
